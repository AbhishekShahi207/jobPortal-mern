...
const submitHandler= async(e)=>{
  e.preventDefault()
  //converting data into form data
    ...
    <div>
      ...
      <div className=" flex items-center justify-center max-w-7xl mx-auto">
        <form
          ...
          className="w-1/2 border border-gray-200 rounded-md p-4 y-10"
        >
          ...
          <div className="my-2">
            ...
            <Input type="text" placeholder="9898xxxxxx"
          ...
          <div className="flex  items-center justify-between">
            <RadioGroup className="flex my-2 items-center  gap-4">
